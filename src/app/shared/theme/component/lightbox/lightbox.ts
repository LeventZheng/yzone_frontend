...
export class Lightbox implements AfterViewInit,OnDestroy{ 
    ...
    center() {
        ...
        let x = (viewport.width - elementWidth - 260) / 2;
        ...
        setTimeout(() => {
            if (this.panel.style.left.substring(0,1) === '-') {
    ...
    onImageLoad(event,content) {
        ...
        this.panel.style.left = Number.parseInt(this.panel.style.left) + (this.domHandler.getOuterWidth(this.panel) - imageWidth) / 2 + 'px';
        this.panel.style.top = Number.parseInt(this.panel.style.top) + (this.domHandler.getOuterHeight(this.panel) - imageHeight) / 2 + 'px';
        ...
        setTimeout(() => {
            ...
            this.loading = false;
        }, Number.parseInt(this.effectDuration));
    }
